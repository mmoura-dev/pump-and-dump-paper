...
\begin{document} 
	...
	Another contribution from their study is an anomaly detection algorithm founded on classification methods.
	...
	\begin{figure}[!ht]
		\centering
		\includegraphics[scale=0.8,trim={0 60 0 60},clip]{figures/met-flow.pdf}

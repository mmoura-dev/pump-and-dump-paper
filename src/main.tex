...
\begin{document} 
	...
	By the end of this section, the subsection "Pump-and-Dump on Cryptocurrency as Anomalies of Time Series" (see Subsection \ref{subsec_pump_as_anomalies}) demonstrates the modeling of pump-and-dumps as anomalies within time series data and proposes methodologies for their detection.
	...
	Hence, a fundamental characteristic of pump-and-dump schemes within cryptocurrency markets is the establishment of publicly accessible groups, wherein every member is aware of the scheme.
	...
	\subsection{Pump-and-Dump on Cryptocurrency as Anomalies of Time Series}
